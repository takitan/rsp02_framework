...
class ITLV
{
	public:
		...
		virtual uint8_t send( rsp02TLV& pkt) = 0;
...
class TinyTLV : public ITLV
{
	...
	public:
		...
		uint8_t pBuf[2][16] =
		{
			{ 0x06, 0x01, 0x0a, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09},
			{ 0x06, 0x02, 0x09, 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08},
		};
