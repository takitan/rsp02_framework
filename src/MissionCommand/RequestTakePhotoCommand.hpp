...
struct RequestTakePhotoCommand_t : public MissionTLV
{
	...
	RequestTakePhotoCommand_t(const void* pkt,int sender) : MissionTLV(pkt,sender),
...
struct RequestTakePhotoResponse_t : public MissionTLV
{
	constexpr static int PayloadSize = 3;
	...
	RequestTakePhotoResponse_t(const void* pkt,int sender) : MissionTLV(pkt,sender),
		NumOfPicture(pv_pnt(0)),
		Dummy0(pv_pnt(1)),
		Dummy1(pv_pnt(2))
	{}
