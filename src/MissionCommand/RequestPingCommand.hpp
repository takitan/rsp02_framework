...
struct RequestPingCommand_t : public MissionTLV
{
	constexpr static size_t PayloadSize = 10;
	RequestPingCommand_t(){}
	RequestPingCommand_t( const void* pkt) : MissionTLV(pkt){}
	RequestPingCommand_t( const void* pkt, int sender) : MissionTLV(pkt,sender){}
};

struct RequestPingResponse_t : public MissionTLV
{
	constexpr static size_t PayloadSize = 10;
	RequestPingResponse_t(){}
	RequestPingResponse_t( const void* pkt) : MissionTLV(pkt){}
	RequestPingResponse_t( const void* pkt, int sender) : MissionTLV(pkt,sender){}
};
